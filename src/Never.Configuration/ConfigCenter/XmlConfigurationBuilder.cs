...
namespace Never.Configuration.ConfigCenter
{
    ...
    public class XmlConfigurationBuilder : IConfigurationBuilder, IShareFileReference
    {
        ...
        public XmlConfigurationBuilder(IEnumerable<ShareConfigurationBuilder> share, ConfigFileInfo fileInfo, ICustomKeyValueFinder keyValueFinder)
        {
            this.share = share;
            this.File = fileInfo;
        ...
        /// 文件类型
        /// </summary>
        public ConfigFileType FileType { get { return ConfigFileType.Xml; } }
        ...
        public XmlConfigurationBuilder Build()
        {
            if (this.builded)
                return this;
        ...
        /// 查询关键字
        /// </summary>
        /// <param name="mode">eat还是use</param>
