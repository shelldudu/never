...
namespace Never.EasySql.SqlClient
{
    ...
    /// sqlite数据库
    /// </summary>
    [Never.Attributes.Summary(Descn = "请先引用初始化Never.SqlClient.SqliteExecuter.DbProviderFactory")]
    public sealed class SqliteExecuter : EasySqlExecuter, ISqlExecuter, ITransactionExecuter
    {
        ...
        public SqliteExecuter(string connectionString)
            : base("@", Never.SqlClient.SqliteExecuter.GetInstance(), connectionString)
        {
        }
