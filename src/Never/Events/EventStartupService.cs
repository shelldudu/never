...
namespace Never.Events
{
    ...
    /// event事件启动
    /// </summary>
    internal class EventStartupService
    {
        public class EventHandlerCtorParameterProcessor : Never.Startups.ITypeProcessor
        {
            /// <summary>
            /// 事件类型
            /// </summary>
            ...
            public EventHandlerCtorParameterProcessor(IEnumerable<Type> ignoreTypes)
            {
        ...
        public class EventNoCtorParamaterProcessor : Never.Startups.ITypeProcessor
        {
            /// <summary>
            /// 事件类型
            /// </summary>
            ...
            /// </summary>
            /// <param name="ignoreTypes"></param>
            public EventNoCtorParamaterProcessor(IEnumerable<Type> ignoreTypes)
            {
                exists.AddRange(ignoreTypes);
            }
            ...
            public void Processing(IApplicationStartup application, Type type)
            {
                ...
                throw new ArgumentNullException(string.Format("type event Type {0} must has no-paramater ctor", type.FullName));
            }
        }
    }
}