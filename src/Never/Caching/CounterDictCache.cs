...
namespace Never.Caching
{
    ...
    /// </summary>
    public class CounterDictCache : CounterDictCache<string, object>, ICaching
    {
        #region 构造
        ...
        public CounterDictCache(int capacity, IEqualityComparer<string> comparer)
        ...
        protected CounterDictCache(int capacity, IDictionary<string, CacheValueObject> dict)
            : base(capacity, TimeSpan.FromMinutes(10), dict, new Never.Threading.MonitorLocker())
        {
        }
