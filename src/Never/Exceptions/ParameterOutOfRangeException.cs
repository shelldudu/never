...
namespace Never.Exceptions
{
    ...
    public class ParameterOutOfRangeException : ParameterException
    {
        ...
        public ParameterOutOfRangeException(string parameterName, string format, params string[] paras)
        ...
        public ParameterOutOfRangeException(string parameterName, string message, Exception innerException)
