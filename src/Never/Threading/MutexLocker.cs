...
{
    /// <summary>
    /// 用内核模式的Mutex关键字共享，排他锁
    /// </summary>
    public sealed class MutexLocker : IRigidLocker, IWaitableLocker, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MutexLocker"/> class.
        /// </summary>
        public MutexLocker()
        {
            this.waitHandle = new Mutex(false);
        }
