...
{
    /// <summary>
    /// 用内核模式的EventWaitHandle关键字共享，排他锁
    /// </summary>
    public sealed class AutoResetEventLocker : IRigidLocker, IWaitableLocker, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AutoResetEventLocker"/> class.
        /// </summary>
        public AutoResetEventLocker()
        {
