...
namespace Never.Serialization.Json.MethodProviders.Nullables.DateTimes
{
    ...
    public class RFC1123StyleDateMethodProvider : DateTimeMethodProvider
    {
        ...
        public override DateTime? Parse(IDeserializerReader reader, JsonDeserializeSetting setting, IContentNode node, bool checkNullValue)
        {
            ...
            return MethodProviders.DateTimes.RFC1123StyleDateMethodProvider.Default.Parse(reader,setting,  node, false);
        }
        ...
        public override void Write(ISerializerWriter writer, JsonSerializeSetting setting, DateTime? source)
        {
            ...
            {
                writer.Write("\"");
                MethodProviders.DateTimes.RFC1123StyleDateMethodProvider.Default.Write(writer, setting, source.Value);
                writer.Write("\"");
                return;
            }
