...
namespace Never.TestConsole
{
    ...
    public class MyMock : IMock
    {
        ...
        public void Write(TestConsole.AEG ed)
        {
        ...
        public void Write(int? abc, TestConsole.AEG? ed)
        {
            var list = new List<object>();
            list.Add(abc.ToString());
            list.Add(abc);
        ...
        public void Write(Program p, TestConsole.AEG ed)
        {
            var list = new List<object>();
            list.Add(p.ToString());
            list.Add(p);
        ...
        public void WriteOut(int abc, out TestConsole.AEG? ed)
        {
            ed = AEG.A;
            var list = new List<object>();
            list.Add(abc.ToString());
        ...
        public void WriteRef(int abc, ref TestConsole.AEG ed)
        {
            var list = new List<object>();
            list.Add(abc.ToString());
            list.Add(abc);
